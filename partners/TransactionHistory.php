            ...
            <div> 
              ...
              <!-- <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">ICargo Partners</span> </a> -->
                ...
                <a href="ordersSample1.php" class="nav_link   " style="margin-bottom: 0px"> <i class='fa fa-box nav_icon'></i> <span >Orders</span> </a> 
                      ...
                      <a href="TransactionHistory.php" class="nav_link_l"><ul style="color:white">Transaction History</ul></a>
...
-->
  ...
  <div class="container mt-3 ">
    ...
    <a class="fa fa-box fa-2x  text-decoration-none" href="TransactionHistory.php"> Transaction History</a> 
...
<div class="titleSearch" style=" padding-bottom:0px">
      <p class="pageDetails" style="margin-left: 30%; font-size:12px; padding-bottom:0px"> Search your previous orders here</p>
      </div>
