            ...
            <div> 
              ...
              <!-- <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">ICargo Partners</span> </a> -->
                ...
                <a href="ordersSample1.php" class="nav_link   " style="margin-bottom: 0px"> <i class='fa fa-box nav_icon'></i> <span >Orders</span> </a> 
                      ...
                      <a href="AcceptedOrders.php" class="nav_link_l  "><ul style="color:white" >Accepted Orders</ul></a>
...
-->
  ...
  <div class="container mt-3 ">
    ...
    <a class="fa fa-box fa-2x  text-decoration-none" href="AcceptedOrders.php"> Accepted Orders</a> 
...
<nav class="navbar  navbar-light bg-light shadow   bg-body rounded">
  <span class="pageDetails"> Available Orders you have accepted</span>
