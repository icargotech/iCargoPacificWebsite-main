...
<!--JQUERY-->
   <title>In-Transit Shipments</title>
            ...
            <div> 
              ...
              <!-- <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">ICargo Partners</span> </a> -->
                ...
                <a href="Shipments.php" class="nav_link" style="margin-bottom: 0px"> <i class='fa fa-truck nav_icon'></i> <span class="nav_name">Shipment</span> </a> 
                      ...
                      <a href="InTransit.php" class="nav_link_l"><ul  style="color:white" >In-Transit</ul></a>
...
-->
  ...
  <div class="container mt-3 ">
    ...
    <a class="fa fa-th-large fa-2x  text-decoration-none" href="InTransit.php"> In-Transit Shipments</a> 
...
<nav class="navbar  navbar-light bg-light shadow   bg-body rounded"><span class="pageDetails"> Your in-transit shipments</span>
...
if(isset($_GET['sort']))
    {
        ...
        $sql = "select * from orders where date_booked='$dte_today' and ac_dc_stat='in-transit'";               
 ...
 while($row=mysqli_fetch_assoc($res))
    {
        ...
        ';
            ...
            $sql = "select * from orders where date_booked between '$ths_week' and '$dte_today'  and ac_dc_stat='in-transit'";                     
 ...
 while($row=mysqli_fetch_assoc($res))
    {
        ...
        ';
             ...
             $sql = "select * from orders where date_booked between '$ths_month' and '$dte_today'  and ac_dc_stat='in-transit'";                     
 ...
 while($row=mysqli_fetch_assoc($res))
    {
        ...
        ';
            ...
            $sql = "select * from orders where date_booked between '$week_Ago' and '$dte_today'  and ac_dc_stat='in-transit'";                  
    ...
    <div class="modal-dialog modal-xl rounded-0"  role="document">
        <div class="modal-content " style="border-radius: 60px">
            ...
            <div class="modal-header">
               <h2 class="modal-title" id="exampleModalLabel" style="padding-left:20px; margin-top:15px">In-Transit Order Details</h2>
