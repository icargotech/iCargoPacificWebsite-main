    ...
    <br><br>
        ...
        <h6 style="color: #5C5C5C"><label style="font-weight: 600">&nbspPackage Info</label><h6>
              ...
              <ul class="justify-content-center">
                    <p class=" text-tertiary-sender" style="color:#gray; text-decoration:none"></i> Date Cancelled:<b>&nbsp '.$datecancel.'</b></p></i>
                    <p class=" text-tertiary-sender" style="color:#gray; text-decoration:none"></i> Reason for Cancellation:<b>&nbsp '.$Reason.'</b></p></i>
