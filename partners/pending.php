            ...
            <div> 
              ...
              <!-- <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">ICargo Partners</span> </a> -->
                ...
                <a href="Shipments.php" class="nav_link" style="margin-bottom: 0px"> <i class='fa fa-truck nav_icon'></i> <span class="nav_name">Shipment</span> </a> 
                      ...
                      <a href="pending.php" class="nav_link_l"><ul style="color:white">Pending</ul></a>
...
-->
  ...
  <div class="container mt-3 ">
    ...
    <a class="fa fa-th-large fa-2x  text-decoration-none" href="pending.php"> Pending Shipments</a> 
...
<nav class="navbar  navbar-light bg-light shadow   bg-body rounded"><span class="pageDetails"> Your pending shipments</span>
...
//row
 while($row=mysqli_fetch_assoc($res))
    {
        echo '
        <tr class=modalButton data-toggle="modal" data-id="'.$row['pending'].'">
        <td>'.$row["order_number"].'</td>
        <td>'.$row["date_of_delivery"].'</td>
        <td>'.$row["sender"].'</td>
        <td>'.$row["recipient"].'</td>
    ...
    <div class="modal-dialog modal-xl rounded-0"  role="document">
        <div class="modal-content " style="border-radius: 60px">
            ...
            <div class="modal-header">
               <h2 class="modal-title" id="exampleModalLabel" style="padding-left:20px; margin-top:15px">Pending Order Details</h2>
