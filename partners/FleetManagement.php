        ...
        <nav class="nav">
            ...
            <div> 
              ...
              <!-- <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">ICargo Partners</span> </a> -->
                ...
                <a href="FleetManagement.php" class="nav_link active" style="margin-bottom: 0px"> <i class='fa fa-clipboard nav_icon'></i> <span class="nav_name">Fleet Management</span> </a> 
...
-->
  ...
  <div class="container mt-3 ">
    ...
    <a class="fa fa-clipboard fa-2x  text-decoration-none" href="FleetManagement.php"> Fleet Management</a> 
    ...
    <div class="row" style=" justify-content: end;">
              ...
              <!-- Button trigger modal -->
              <button type="button" class="btn btn-warning rounded-pill" data-bs-toggle="modal" data-bs-target="#vehicle_insert_modal" data-bs-target="#exampleModal" >
              <i class="fa fa-plus" aria-hidden="true"></i>
              Add Vehicle
              </button>
          
              <div class="select_Sort ">
              <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="vehicletype">
                <option selected value="">Manage</option>
    ...
    <nav class="navbar  navbar-light bg-light shadow   bg-body rounded"><span class="pageDetails"> Vehicle List</span >

    <div class="titleSearch">
      
    <form action='ordersSample1.php' method='post'> 

    <input type="type" name = "ordernum" id = "search_vehicle" value = "" onkeyup="searchvehicle()" placeholder=" Search Vehicle" style="padding: 0px;">  
      </div>
    </nav>

       
            <table id="vehicleTable" class="table table-hover table-responsive-xl">
              <thead class="thead-light">
                <tr align ="center">
              ...
              <!--display data from database-->
            <tbody id="displaydataVehicle">
                <?php
                include 'database.php';
                $query ="select name, type, status, conditionss from vehicles";
                $result = $conn->query($query);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
    ...
    <div class="modal fade" id="vehicle_insert_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="vehicle_insert_modalLabel" aria-hidden="true">
      <div class="modal-dialog ">
        <div class="modal-content" style="border-radius: 60px;">
        <div class="modal-header">
                  <h5 class="modal-title" id="vehicle_insert_modalLabel" style="padding-left:20px; margin-top:15px">Add Vehicles</h5>
                  <i type="button" class="fa fa-times fa-lg" data-bs-dismiss="modal" style="margin-right: 30px; margin-top:15px; text-decoration:none;"></i>
                </div>           
          ...
          <div class="modal-body">
            <form >
              <br>  
                <div class="material-textfield">
                  <input placeholder=" " type="text" name="vname" id="vname"  autocomplete="off" value="" size="30"></input>
                ...
                <div class="material-textfield">
                  <span class="countryNum_con">
                    <select  name="countrynumber" class="countryNum" id="vtype" style="width: 155%; float: right;"  >
                        <option value="Unset">Select Vehicle Type</option>
                        <option value="Small Pickup">Small Pickup</option>
                        <option value="Closed Van">Closed Van</option>
                        <option value="Pickup Truck">Pickup Truck</option>
                        <option value="6w Fwd Truck">6w Fwd Truck</option>
                ...
                <div class="material-textfield">
                  <input placeholder=" " type="text" name="condition" id="condition"  autocomplete="off" value="" size="30"></input>
          ...
          <div style="text-align:center" >
            <p id="vehcStatus" style="color: #0095ff;"></p>
          </div>

            <div class="btnModal">
            <button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal" name="close_vehc" id="close_vehc">Close</button>
            <button type="button" class="btn btn-warning rounded-pill" name="vhcSubmit" id="vehcSubmit">Save</button>
          </div>
    ...
    <div class="modal fade" id="vehicle_update_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="vehicle_update_modalLabel" aria-hidden="true">
      <div class="modal-dialog ">
        <div class="modal-content" style="border-radius: 60px;">
        <div class="modal-header">
                  <h5 class="modal-title" id="vehicle_update_modalLabel" style="padding-left:20px; margin-top:15px">Update Vehicle</h5>
                  <i type="button" class="fa fa-trash fa-lg"  aria-hidden="true" name="remove_vehicle" id="remove_vehicle" style="margin-right: 30px; color:red; margin-top:15px; text-decoration:none;"></i>
                  </div>      
            ...
            <div class="material-textfield">
                  <input   placeholder=" "  name="vehicle_name" id="vehicle_name" type="text"  autocomplete="off" value="" 
                        size="30" style=" font-weight: bold;"  disabled></input>
                  <label>Vehicle Name</label>
                </div>
                ...
                <div class="material-textfield ">
                  <input   placeholder=" "  name="vehicle_type" id="vehicle_type" type="text"  autocomplete="off" value="" 
                  ...
                  <label>Vehicle Type</label>
                    ...
                    <div class="material-textfield row justify-content-center" style="margin: auto; justify-content: center; margin-right: 10%">
                        <div>
                        <input type="checkbox" name="status" id="status1" class="get_value" value="Available"> Available&nbsp;&nbsp;&nbsp;  
                        </div> <br>
                        <div>
                        <input type="checkbox" name="status" id="status2" class="get_value" value="On Transit"> On Transit  &nbsp;&nbsp;&nbsp;
                        </div><br>
                        <div>
                        <input type="checkbox" name="status" id="status3" class="get_value" value="Under Maintenance"> Under Maintenance  &nbsp;&nbsp;&nbsp;
                        </div><br>
                    </div>
                    <br><br><br>
                ...
                <div style="text-align:center" >
                <p id="vehicleStatus" style="color: #0095ff; "></p>
              </div>
       
          <div class="btnModal">
            <button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal"  name="close_vehci" id="close_vehc" >Cancel</button>
            <button type="button" class="btn btn-warning rounded-pill"  name = "udatedvehicle" id="udatedvehicle">Update</button>
          </div>
    ...
    <!-- ----------------- For Display vehicle -------------------- -->
      ...
      <!-- create row to become clickable and open modal -->
        ...
        <script>
          var table = document.getElementById("displaydataVehicle");
...
<!--Search filter for vehicle-->
<script>
  
    function searchvehicle() {
      var input, filter, table, tr, td, i, txtValue;
      input = document.getElementById("search_vehicle");
      filter = input.value.toUpperCase();
