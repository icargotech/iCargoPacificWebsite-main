...
$response='<form action="updatee.php" method="POST" class="rounded" >
    ...
    <br><br>
        ...
        <h6 style="color: #5C5C5C"><label style="font-weight: 600">&nbspPackage Info</label><h6>
              ...
              <p>Set Status to:<span>&nbsp&nbsp&nbsp
              ...
              <p>Time Delivered: <span><input type="time" name="time" class="input_modal"></p>
              <p>Date Delivered: <span><input type="date" name="date"class="input_modal" ></p>
