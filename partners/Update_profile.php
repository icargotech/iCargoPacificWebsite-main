...
if (isset($_POST['update'])) 
{
    ...
    $bio = filter_var( mysqli_real_escape_string($conn,$_POST['bio']), FILTER_SANITIZE_STRING);
    ...
    $company = filter_var( mysqli_real_escape_string($conn,$_POST['company']), FILTER_SANITIZE_STRING);
    ...
    {   
        ...
        move_uploaded_file($fn, $target);
         ...
         $sql = "
        UPDATE signup_partners_users 
        SET firstname = '$firstname', lastname = '$lastname', bio = '$bio', conact_no = '$contact', email = '$email', company_name = '$company', Image = '$dbfname'
        WHERE id = '$id'";
        ...
        $sql = "
        UPDATE signup_partners_users 
        SET firstname = '$firstname', lastname = '$lastname', bio = '$bio', conact_no = '$contact', email = '$email', company_name = '$company' 
        WHERE id = '$id'";
        $result = mysqli_query ($conn , $sql);
