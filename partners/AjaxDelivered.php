...
$stat=$result['status'];
$pup=$result['pick_up_time'];
$driver=$result['driver'];
$vehicles=$result['vehicle'];
$datedeli=$result['date_delivered'];
$timedeli=$result['time_deliver'];
...
$response='<form class="rounded">
    ...
    <br><br>
        ...
        <h6 style="color: #5C5C5C"><label style="font-weight: 600">&nbspPackage Info</label><h6>
              ...
              <h6 style="color: #5C5C5C"><label style="font-weight: 600">&nbsp Delivery Info</label><h6>
              
              <ul class="justify-content-center">
                    <p class=" text-tertiary-sender" style="color:#gray; text-decoration:none"></i> Date Delivered:<b>&nbsp '.$datedeli.' &nbsp '.$timedeli.' </b></p></i>
                   
                    <p class=" text-tertiary-sender" style="color:#gray; text-decoration:none"></i> Assigned Vehicle:<b>&nbsp '.$vehicles.'</b></p></i>
                    <p class=" text-tertiary-sender" style="color:#gray; text-decoration:none"></i> Assigned Driver:<b>&nbsp '.$driver.'</b></p></i>
              </ul> 
