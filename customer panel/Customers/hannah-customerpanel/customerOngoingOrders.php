...
require_once('config.php');
 ...
 $query="SELECT * from orders where status='In-transit'";
    ...
    <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
        <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
            <div class="navbar-nav m-auto py-0 align-items-center">
                <h5 class="font-weight-light"><a href="./customerOngoingOrders.php" class="nav-item nav-link active font-weight-bold" style="color: #1b508e;">Ongoing</a></h5>
...
{
 ?>
<form action="customerTrackOrders.php" method="POST">
<table class="table table-bordered align-items-center p-2 col-md-6 bg-light shadow" style="margin-left: 340px">
    <thead style="background-color: #1b508e">
      <tr>
        <th scope="col" class="text-light d-inline-flex"><h4 class="text-light">ㅤㅤ<?php echo $rows['date_of_delivery'] ?></h4>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ<button type="submit" name="subid" value="<?php echo $rows['order_number'] ?>" class="btn btn-secondary font-weight-bold text-dark"><a class="text-dark" >Track</a></button></th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <!-- <table class="table table-bordered align-items-center p-2 col-md-6 bg-light shadow" style="margin-left: 340px">
    <thead style="background-color: #1b508e">
      <tr>
        <th scope="col" class="text-light d-inline-flex"><h4 class="text-light">ㅤㅤMarch 25, 2022ㅤ3:00pm</h4>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ<button type="button" class="btn btn-secondary font-weight-bold text-dark"><a class="text-dark" href="./customerTrackOrders.html">Track</a></button></th>
      </tr>
    </thead>
    <tbody>
      <tr>
