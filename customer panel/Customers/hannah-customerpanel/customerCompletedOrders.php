    ...
    <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
        <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
            <div class="navbar-nav m-auto py-0 align-items-center">
                ...
                <h5 class="font-weight-light"><a href="./customerCompletedOrders.html" class="nav-item nav-link active font-weight-bold" style="color: #1b508e">Completed</a></h5>
                ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ
                <h5 class="font-weight-light"><a href="./customerCancelledOrders.php" class="nav-item nav-link" style="color: #1b508e">Cancelled</a></h5>
            </div>  
        </div>
    </div>
</nav>
...
{
 ?>
 <form action="customerCompletedOrderSummary.php" method="POST">
<table class="table table-bordered align-items-center p-2 col-md-6 bg-light shadow" style="margin-left: 340px">
    <thead style="background-color: #1b508e">
      <tr>
        <th scope="col" class="text-light d-inline-flex"><h4 class="text-light">ㅤㅤ<?php echo $rows['date_delivered'] ?></h4>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ<button type="submit" name="subid" value="<?php echo $rows['order_number'] ?>" class="btn btn-secondary font-weight-bold text-dark"><a class="text-dark"    > View</a></button></th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <!-- <table class="table table-bordered align-items-center p-2 col-md-6 bg-light shadow" style="margin-left: 340px">
    <thead style="background-color: #1b508e">
      <tr>
        <th scope="col" class="text-light d-inline-flex"><h4 class="text-light">ㅤㅤMarch 25, 2022ㅤ3:00pm</h4>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ<button type="button" class="btn btn-secondary font-weight-bold text-dark"><a class="text-dark" href="./customerCompletedOrderSummary.php">View</a></button></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <th scope="row">ㅤㅤㅤㅤㅤㅤ<span class="fa fa-location-arrow text-warning"></span> House No., Street, Barangay, City, Country, Postal Code</th>
      </tr>
      <tr>
