...
<link href="css/Accordion.scss" rel="stylesheet">
<link href="css/PaymentBanner.css" rel="stylesheet">
<!--
                        ...
                        <div class="container  mx-auto d-flex flex-container ">
                          <div class="col-md-12">
                            <ul class="steps steps-5 text-center">
                              <li><a href="#" title=""><em>Order Details</em></a></li>
                              <li><a href="#" title=""><em>Order Safety</em></a></li>
                              <li ><a href="#" title=""><em>Summary</em></a></li>
                              <li ><a href="#" title=""><em>Payment</em></a></li>
                              <li class="current"><a href="#" title=""><em>Confirmation</em></a></li>
                           </ul>
                          </div>
                        </div>
                  ...
                  <div class=" col align-items-center flex-container px-4 px-sm-5">
                    <form class="text-center">
                      ...
                      <div class="justify-content-center">   
                          <div class="col mx-auto mt-3">   
                            ...
                            <div class=" row d-flex flex-end">
                              <div class="col-12 col-sm-6 col-md-7 col-lg-8 col-xl-9">
                                <!--
                                <h4 class="text-left text-dark">Payment Confirmation</h4>
                                <h6 class="text-left text-dark mt-3 h5 mb-3">Payment details</h6> -->
                              </div>  
                        ...
                        <div class= "col-sm mt-5 flex-container" >
                                <div class="container">
                                  <div class="row flex-container  ">

                                      <!-- Summary Details start-->
                                      <div class="container col-lg-12 mt-0">
                                        <h2 class="text-center text-warning mt-3">[00000] PHP</h2>
                                          ...
                                          <div class= "col-md-auto px-5 ">
                                            ...
                                            <p class="row-6  "> Order ID  </p>
                                            </div>

                                            <div class= "row-6 fw-bold text-left text-dark h6 mb-0 ">
                                              <p class="row-6 "> Order Date </p>
                                            </div>
                                            

                                            <div class= "row-6 fw-bold text-left text-dark h6 mb-0 ">
                                              <p class="row-6 "> Payment Type</p>
                                            </div>
                                          ...
                                          <div class= "col-md-auto px-5 ">
                                            ...
                                            <div class="row-6 fw-bold text-dark text-left  h6 "> 
                                              <p class="row-6  "> 52386289</p>
                                            </div>

                                            <div class="row-6 fw-bold text-dark text-left  h6 "> 
                                              <p class="row-6  "> May 30, 2022 18:34</p>
                                            </div>

                                            <div class="row-6 fw-bold text-dark text-left  h6 "> 
                                              <p class="row-6  "> [Cash on Payment or E-Wallet]</p>
                                            </div>
                            ...
                            <p class="mt-5 mb-5">You will receive an order confirmation email with details of your order. </p>
                            <a href="hannah-customerpanel/customerOngoingOrders.php" class=" btn btn-primary shadow font-weight-regular mt- mb-5" data-toggle=" " >Go to Orders</a>
