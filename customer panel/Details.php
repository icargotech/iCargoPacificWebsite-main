                  ...
                  <div class=" col-6  align-items-center px-4 px-sm-5 border-top-3rem">
                        ...
                        <div class="justify-content-center">   
                            ...
                            <h6 class="text-left text-dark">Name</h6>
                              ...
                              <div class="form-group text-center d-flex align-items-center">
                                  <input type="text" class="form-control border-0 p-4 bg-secondary shadow p-3 mb-2 bg-secondary" placeholder="VAT-ID (optional)" required="required" name="bvat" id="end"/>
                              </div>
                            ...
                            <div class="accordion mt-3  ">
                                    ...
                                    <div class=" panel justify-content-left ">
                                      <div class=" col-4 mx-auto text-left">
                                        <label text-start><input type="checkbox" disabled="disabled" checked> Standard Service</input></label>
                                        <label text-start><input type="checkbox" name="services" value="Special Assistance"> Special Assistance</label>
                                        <label text-start><input type="checkbox" name="services" value="Customer Service"> Customer Service</label>
                                        <label text-start>
                                          <input type="checkbox"> Tarpaulin Cover</input>
                                          <h6 class="mt-0 px-4">PHP 50</h6>
                                          </label>
                              ...
                              <!-- <form class="text-center"> -->
                                ...
                                <div class="container">
                                  ...
                                  <h4 class="text-left text-dark">Pick-up Information</h4>
                                    ...
                                    <div class="col-md-auto ">
                                      <label>
                                    <input type="radio" name="oras"  class="card-input-element d-none" id="do-call" data-toggle="collapse" data-target="#Quick" aria-expanded="false" aria-controls="" value="ASAP">
                                                ...
                                                <h6 class="text-left text-dark">Pick-up Date & Time</h6>
                                                  <div class=" datepickers  form-group text-center d-flex align-items-center" action="" method="post">
                                                      ...
                                                      <div class="input-group date" id="id_0">
                                                        <input type="text" name="oras" class="form-control border-0 p-4 bg-secondary shadow p-3 mb-2 bg-secondary" placeholder="MM/DD/YYYY hh:mm:ss" required/>
                                                      </div>
                              ...
                              <div class="col-lg-12  text-center mx-auto  mt-5 mb-5" id="">
                                <div class=" col d-flex justify-content-between">
                                 ...
                                 <div class=" d-flex mx-auto">
                                   <a class="btn btn-primary shadow p-3 mb-5 font-weight-bold" href="Safety.php" role="button">ㅤContinueㅤ</a>
                                </div> 
