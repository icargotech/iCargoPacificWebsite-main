...
<!-- <div class="text-end text-white mx-2"><i class="bi bi-bell-fill"></i> Notification</div> -->
 ...
 <a class="btn btn-dark position-relative text-end" type="button"id="dropdownMenuClickableInside" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"> Notification: <span class="badge bg-warning text-dark" id="counter">0</span> </a>
     <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end" aria-labelledby="dropdownMenuClickableInside" id="status">
...
var xhttp = new XMLHttpRequest();
  ...
  xhttp.open("GET", "AJAX_ctr_notif.php", true);
  xhttp.send();
      },100);
}
...
let val2;
   ...
   $.ajax({
      method: "POST",
      url: "AJAX_ctr_notif_drop_menu.php",
      success: function (data) {
        if(data != val2){
