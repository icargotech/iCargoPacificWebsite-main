...
if(empty($Password)){
     ...
     $Password_error = true;     
     $Password_msg = "Must contain atleast 8 character";
}
...
if($firstname_error == false && $lastname_error == false && $email_error == false && $Password_error == false && $Password_error == false && $confirmpass_error == false){
    ...
    $query = "insert into customer_info (first_name, last_name, email, password, contact_no) values ('$firstname' , '$lastname' , '$email' , '$Password' , '$contact_no')";
