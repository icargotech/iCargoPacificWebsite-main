	...
	<div class="container">
		...
		<div class="row justify-content-center text-center">
			<div class="d-grid col-lg-2 ">   
	          <button onclick="window.location.href='Panel.php';" type="button" href="panel.php" class="text-decoration-none border-bottom border-5 p-5 fs-5 text-light" 
	          style="background-color:#440262; border: none;">RATE & TRANSIT TIME</button>
	        </div>
	        <div class="d-grid col-lg-2 ">   
		...
		<div class="row justify-content-center">
			<div class="col-lg-6 pt-4">
				...
				<div class="mb-3">
				  <label for="" class="form-label fs-5 ps-3">Pick-up Address</label>
				  <input type="text" class="form-control form-control-lg shadow-sm rounded-pill"  placeholder="House Number, Building, Street Name, City">
				</div>
				...
				<p class="fs-4 lead pt-4">Reciepient Details</p>

				<div class="mb-3">
				  <label for="" class="form-label fs-5 ps-3">Destination address</label>
				  <input type="text" class="form-control form-control-lg shadow-sm rounded-pill"  placeholder="House Number, Building, Street Name, City">
				</div>
				<div class="row justify-content-between">
					<div class="col-lg-6 mb-3">
				...
				<div class="row justify-content-center">
					<div class="col-lg-6 d-grid py-5">
						<button class="fs-3 btn btn-lg btn-warning text-light shadow-lg rounded-pill  mt-3 mb-3">SHOW RATES</button>
					</div>
					<hr>
					<div class="row justify-content-evenly mb-5">
						<div class="col-3">
							<p class="fw-bold">ARRIVES ON</p>
							<p class="lead">Thu, May 26</p>
						</div>
						<div class="col-3">
							<p class="fw-bold">DELIVERED BY</p>
							<p class="lead">6:00 PM</p>
						</div>
						<div class="col-6">
							<a class="btn btn-warning btn-lg float-end text-light fs-3 shadow-sm  py-4 px-5 ">US$951.00</a>
						</div>
					</div>
					<div class="row justify-content-evenly mb-5">
						<div class="col-3">
